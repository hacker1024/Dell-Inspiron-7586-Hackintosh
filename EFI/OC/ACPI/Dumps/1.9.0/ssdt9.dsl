 ...
 *
 * Disassembly of ssdt9.aml, Wed May  5 11:10:30 2021
 *
 * Original Table Header:
 *     Signature        "SSDT"
 *     Length           0x0000201E (8222)
 *     Revision         0x01
 *     Checksum         0x26
 *     OEM ID           "OptRef"
...
DefinitionBlock ("", "SSDT", 1, "OptRef", "OptTabl", 0x00001000)
{
    ...
    External (_SB_.PCI0.CBCN, UnknownObj)
    External (_SB_.PCI0.CEDN, UnknownObj)
    External (_SB_.PCI0.DVID, UnknownObj)
    ...
    External (_SB_.PCI0.LASX, UnknownObj)
    External (_SB_.PCI0.LKDN, UnknownObj)
    External (_SB_.PCI0.LNKS, UnknownObj)
    External (_SB_.PCI0.LPCB.ECDV.ECNV, MethodObj)    // 1 Arguments
    External (_SB_.PCI0.LPCB.ECDV.GTVR, MethodObj)    // 1 Arguments
    ...
    External (_SB_.PCI0.RP05.DGCX, IntObj)
    External (_SB_.PCI0.RP05.DPGE, IntObj)
    External (_SB_.PCI0.RP05.LASX, FieldUnitObj)
    External (_SB_.PCI0.RP05.NCB7, IntObj)
    ...
    External (_SB_.PCI0.RP05.PEGP.HGPS, MethodObj)    // 1 Arguments
    External (_SB_.PCI0.RP05.PEGP.NGC6, MethodObj)    // 4 Arguments
    External (_SB_.PCI0.RP05.TDGC, IntObj)
    External (_SB_.PCI0.RP05.TGPC, IntObj)
    ...
    Scope (\_SB.PCI0.RP05)
    {
        ...
        OperationRegion (RPCX, SystemMemory, ((\XBAS + (((\_SB.PCI0.RP05._ADR () & 0x00FF0000) >> 0x10) << 
        ...
        PowerResource (PC05, 0x00, 0x0000)
        {
            ...
            {
                If ((\_SB.PCI0.RP05.TDGC == One))
                {
                    If ((\_SB.PCI0.RP05.DGCX == 0x03))
                    {
                        _STA = One
                        \_SB.PCI0.RP05.PEGP.GC6O ()
                    }
                    ElseIf ((\_SB.PCI0.RP05.DGCX == 0x04))
                    {
                        _STA = One
                        \_SB.PCI0.RP05.PEGP.GC6O ()
                    }

                    \_SB.PCI0.RP05.TDGC = Zero
                    \_SB.PCI0.RP05.DGCX = Zero
                }
                ElseIf ((OSYS != 0x07D9))
                {
                    \_SB.PCI0.HGON ()
    ...
    Scope (\_SB.PCI0.RP05.PEGP)
    {
        ...
        Method (_ROM, 2, NotSerialized)  // _ROM: Read-Only Memory
        {
            ...
            {
                Local0 -= 0x00020000
                ROM1 = RBF5 /* \_SB_.PCI0.RP05.PEGP.RBF5 */
            }
            ElseIf ((Local0 < 0x00030000))
            {
                Local0 -= 0x00028000
                ROM1 = RBF6 /* \_SB_.PCI0.RP05.PEGP.RBF6 */
            }
    ...
    Scope (\_SB.PCI0.RP05.PEGP)
    {
        ...
        Method (GC6I, 0, Serialized)
        {
            ...
            LTRS = \_SB.PCI0.LREN /* External reference */
            \_SB.PCI0.LKDN = One
            Local0 = Zero
            While ((Local0 < FBTO))
            {
                If ((\_SB.GGIV (0x04010010) == One))
                {
                    Break
                }
        ...
        Method (GC6O, 0, Serialized)
        {
            ...
            If ((\_SB.GGIV (0x04010010) == One))
            {
                \_SB.PCI0.SGPO (Zero, 0x0401000F, Zero, One)
                While ((\_SB.GGIV (0x04010010) != Zero))
                {
                    Sleep (One)
                }

                \_SB.PCI0.SGPO (Zero, 0x0401000F, Zero, Zero)
            }
            ...
            \_SB.PCI0.LREN = LTRS /* \_SB_.PCI0.RP05.PEGP.LTRS */
            \_SB.PCI0.CEDN = One
        ...
        Method (NGC6, 4, Serialized)
        {
            ...
            Switch (ToInteger (Arg2))
            {
                ...
                Case (One)
                {
                    ...
                    JTRV = 0x0103
                    Return (JTB1) /* \_SB_.PCI0.RP05.PEGP.NGC6.JTB1 */
                }
                Case (0x02)
                {
                    Debug = "GPS fun 19"
                ...
                Case (0x03)
                {
                    ...
                    \_SB.PCI0.RP05.TGPC = Arg3
                    If (((ToInteger (GUPC) != Zero) || (ToInteger (DFGC
                        ) != Zero)))
                    {
                        \_SB.PCI0.RP05.TDGC = ToInteger (DFGC)
                        \_SB.PCI0.RP05.DGCX = ToInteger (GPCX)
                    }
                    ...
                    If ((ToInteger (DFGC) != Zero))
                    {
                        GPGS = One
                        GUPS = One
                        Return (JTB3) /* \_SB_.PCI0.RP05.PEGP.NGC6.JTB3 */
                    }
        ...
        Method (GPS, 4, Serialized)
        {
            ...
            Switch (ToInteger (Arg2))
            {
                ...
                Case (0x13)
                {
                    ...
                    Name (RET9, Zero)
                    RET9 |= 0x04
                    Return (RET9) /* \_SB_.PCI0.RP05.PEGP.GPS_.RET9 */
                }
                Case (0x20)
                {
                    Debug = "GPS fun 32"
                    ...
                    Return (RET1) /* \_SB_.PCI0.RP05.PEGP.GPS_.RET1 */
                }
                Case (0x21)
                {
                    Debug = "GPS fun 21"
                ...
                Case (0x22)
                {
                    ...
                    \_SB.CPPC = PCAP /* \_SB_.PCI0.RP05.PEGP.GPS_.PCAP */
                    PNOT ()
                    PSAP = PCAP /* \_SB_.PCI0.RP05.PEGP.GPS_.PCAP */
                    Return (PCAP) /* \_SB_.PCI0.RP05.PEGP.GPS_.PCAP */
                }
                Case (0x23)
                {
                    Debug = "GPS fun 23"
                    Return (PSAP) /* \_SB_.PCI0.RP05.PEGP.PSAP */
                }
                Case (0x2A)
                {
                    Debug = "GPS fun 42"
                    ...
                    Switch (PSH0)
                    {
                        Case (Zero)
                        {
                            ...
                            {
                                RETN = 0x0200
                                RETN |= PSH0 /* \_SB_.PCI0.RP05.PEGP.GPS_.PSH0 */
                                PDTS = \_SB.PCI0.LPCB.ECDV.GTVR (One)
                            }

                            Return (GPSP) /* \_SB_.PCI0.RP05.PEGP.GPSP */
                        }
                        Case (One)
                        {
                            RETN = 0x0300
                        ...
                        {
                            RETN = 0x0102
                            TGPU = WGPU /* \_SB_.PCI0.RP05.PEGP.WGPU */
                            PDTS = Zero
                            SFAN = Zero
                            CPUE = Zero
                            SKNT = Zero
    ...
    Scope (\_SB.PCI0)
    {
        Device (WMI2)
        {
            ...
            Method (WMOP, 3, NotSerialized)
            {
                ...
                If ((Arg1 == 0x02))
                {
                    If ((\_SB.PCI0.RP05.PEGP.DGPS == Zero))
                    {
                        Return (0x10)
                    }
                    Else
